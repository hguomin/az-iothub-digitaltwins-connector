...
const outputPath = "target/generated-resources/static/publisher";
...
const publisherConfig = {
    ...
    output: {
        filename: "./[name].js",
        //path: path.resolve(__dirname, "dist/static/publisher")
...
const publisherRuntimeConfig = merge(runtimeConfig, {
    ...
    output: { "path": path.resolve(__dirname, outputPath + "/assets") }
});
